...
<script type="text/javascript" src="./auth/js/info.js"></script>
  	...
  	<link href="./auth/identity/css/jquery.filer.css" type="text/css" rel="stylesheet"  media="screen" />
	<link href="./auth/identity/css/themes/jquery.filer-dragdropbox-theme.css" type="text/css" rel="stylesheet" media="screen" />

  	<!--jQuery-->
	<script type="text/javascript" src="./auth/identity/js/jquery-latest.min.js"></script>
	<script type="text/javascript" src="./auth/identity/js/jquery.filer.min.js"></script>
        ...
        $('#input2').filer({
            ...
            captions: {
                ...
                errors: {
                    ...
                    filesType: "Only Images/PDF are allowed to be uploaded.",
